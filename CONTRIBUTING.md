...
We would love for you to contribute to eximap and help make it even better than it is
...
Help us keep eximap open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests.
You've got much better chances of getting your question answered on [Gitter](https://gitter.im/eximap).

## <a name="issue"></a> Found a Bug?
If you find a bug in the source code, you can help us by
[submitting an issue](#submit-issue) to our [GitHub Repository](https://github.com/around25/eximap).
...
You can file new issues by filling out our [new issue form](https://github.com/around25/eximap/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/around25/eximap/pulls) for an open or closed PR
...
* Run the full eximap test suite, as described in the [developer documentation](DEVELOPER.md),
...
* In GitHub, send a pull request to `eximap:develop`.
* If we suggest changes then:
  * Make the required updates.
  * Re-run the eximap test suites to ensure tests are still passing.
...
we use the git commit messages to **generate the eximap change log**.
...
Samples: (even more [samples](https://github.com/around25/eximap/commits/develop))
...
* **build**: Changes that affect the build system or external dependencies (example scopes: poison, phoenix)
